...
<html>
    <head>
        ...
        <title>Admin - Sửa sản phẩm ${productDetails.getProduct().getProductName()}</title>
        <style>
            .valid-feedback{
                display: block;
            }
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>Sửa sản phẩm ${productDetails.getProduct().getProductName()}</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
            ...
            <form class="row mb-2"  id="form-edit-product" method="post">
                <div class="col-lg-8">
                    <!-- Circle Buttons -->
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body row">
                            <div class="col-lg-12">
                                <input type="hidden" name="productId" value="${productDetails.getProduct().getId()}">
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <div class="preview-image">
                                            <label for="preview-img">Hình ảnh</label>
                                            <img id="preview-img" alt="" id="preview-img" class="img-thumbnail"
                                                 src="<%=request.getContextPath()%>/assets/images/product/${productDetails.getProduct().previewImage}"
                                                 style="display: inherit; width: 100px; height: 100px;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="preview">Thay đổi hình ảnh</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Tên sản phẩm" value="${productDetails.getProduct().getProductName()}">
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        <label for="original_price">Giá nhập</label>
                                        <input type="text" class="form-control" id="original_price" name="original_price"
                                               placeholder="Giá nhập"  value="${productDetails.getProduct().getOriginalPrice()}">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="initial_price">Giá khởi tạo (nếu có)</label>
                                        <input type="text" class="form-control" id="initial_price" name="initial_price"
                                               placeholder="Giá khởi tạo" value="${productDetails.getProduct().getInitialPrice()}">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="unit_price">Giá bán</label>
                                        <input type="text" class="form-control" id="unit_price" name="unit_price"
                                               placeholder="Giá bán" value="${productDetails.getProduct().getUnitPrice()}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="quantity" name="quantity"
                                               placeholder="Số lượng" value="${productDetails.getProduct().getQuantity()}">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="insurance">Bảo hành</label>
                                        <input type="text" class="form-control" id="insurance" name="insurance"
                                               placeholder="Bảo hành" value="${productDetails.getProduct().getInsurance()}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody id="table-attribute">
                                            <c:set var="i" value="0" />
                                            <c:forEach var="psa" items="${productSpecifiedValue}">
                                                ...
                                                <tr>
                                                        ...
                                                        <select class="form-control select2 attribute" name="attribute" >
                                                            ...
                                                            <c:forEach var="attribute" items="${attributes}">
                                                                <option value="${attribute.id}"
                                                                        ${psa.specifiedAttribute.id == attribute.id ? "selected" : ""}
                                                    ...
                                                    <td>
                                                        <select class="form-control select2" name="specified_attribute">
                                                            <option value="${psa.id}" selected>${psa.name}</option>
                                                        </select>
                                                    </td>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status1" name="status">
                                        <c:forEach var="status" items="${productStatus}">
                                            <option value="${status.id}" ${productDetails.getProduct().getStatus().id == status.id ? "selected" : ""}>${status.statusName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="category" name="categoryId" >
                                    ...
                                    <c:forEach var="category" items="${categories}">
                                        <option value="${category.id}" ${productDetails.getProduct().getCategory().getId()==category.id?'selected':''}>${category.categoryName}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="brand" name="brandId" >
                                    ...
                                    <c:forEach var="brand" items="${brands}">
                                        <option value="${brand.id}" ${productDetails.getProduct().getBrand().getId()==brand.id?'selected':''}>${brand.brandName}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="card-body row">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody id="table-image">
                                    <c:forEach var="image" items="${productDetails.getImages()}">
                                        <tr>
                                            <td class="text-center">1</td>
                                            <td>
                                                <div class="detail-image">
                                                    <img src="<%=request.getContextPath()%>/assets/images/product-details/${image}" alt="" class="img-thumbnail"
                                                         style="width: 100px; height: 100px;display:inherit">
                                                    <input type="hidden" name="image_details_text" value="${image}">
                                                </div>
                                            </td>
                                            <td>
                                                <input type="hidden" class="form-control" name="image_details" onchange="readURL(this)" 
            ...
            <c:forEach var="attribute" items="${attributes}">
                                                ...
                                                $("#form-edit-product").validate({
                                                    ...
                                                    submitHandler: function (form) {
                                                        ...
                                                        $.ajax({
                                                            url: "<%=request.getContextPath()%>/admin/product/edit",
                                                            type: "POST",
                                                            data: formData,
                                                            contentType: false,
                                                            cache: false,
